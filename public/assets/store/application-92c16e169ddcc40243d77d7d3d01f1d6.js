...
(function() {
  ...
  cart = {
    initialize: function() {
      ...
      this.cartContent = $('#cart-modal-content');
      return this.cartItemsCount = $('#cart-items-count');
    },
    hide: function() {
      return this.cartModal.modal('hide');
    },
    show: function() {
      return this.cartModal.modal('show');
    },
    update: function(html, count) {
      this.cartContent.html(html);
      return this.cartItemsCount.html(count);
    },
    updateAndShow: function(html, count) {
      this.update(html, count);
      return this.show();
    }
  };
